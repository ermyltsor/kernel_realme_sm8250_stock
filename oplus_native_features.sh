...
export OPLUS_FEATURE_OTA_DDR5_COMPATIBLE=yes
...
export OPLUS_FEATURE_GAME_OPT=yes
export OPLUS_FEATURE_CAMERA_COMMON=yes
export OPLUS_FEATURE_VIRTUAL_CAMERA=yes
export OPLUS_FEATURE_PHYSICAL_CAMERA_PROVIDER_VERSION=2.4
...
export OPLUS_FEATURE_QVA_MIC_SUPPORT=yes
export OPLUS_FEATURE_CAR_VOICE_DL_MUTE=yes
export OPLUS_FEATURE_DOLBY_ATMOS_GAME=yes
...
export OPLUS_FEATURE_ADSP_SSR_TEST=true
