...
/* james.zhu@MULTIMEDIA.DISPLAY.LCD, 2021/02/15, oplus dither */
...
int oplus_display_panel_get_vendor(void *buf)
{
	...
	vendor = NULL;(char *)display->panel->oplus_priv.vendor_name;
	manu_name = NULL;(char *)display->panel->oplus_priv.manufacture_name;
